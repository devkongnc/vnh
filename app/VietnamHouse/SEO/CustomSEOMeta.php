...
class CustomSEOMeta implements MetaTagsContract
{
    /**
     * The meta title.
     *
    ...
    public function getDefaultTitle()
    {
        if (empty($this->title_default)) {
            return \getLocaleValue($this->config->get('defaults.title', null));
        }
    ...
    public function getDescription()
    {
        ...
        return $this->description ?: \getLocaleValue($this->config->get('defaults.description', null));
    }
