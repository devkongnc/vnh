                                        ...
                                        <form id="menu-add">
                                            <div class="form-group">
                                                @foreach ($pages as $page)
                                                    <div><label><input class="icheck checkmenu" type="checkbox"
                                                                       name="itmenus[]"
                                                                       data-text="{{ "$page->title ($page->permalink)" }}"
                                                                       value="{{ $page->id }}"/>{{ "$page->title ($page->permalink)" }}
                                                        </label></div>
                                                @endforeach
                                            </div>
                                            <button class="btn btn-primary"
                                                    id="addButton">@lang('admin.common.add new')</button>
                                        </form>
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                        ...
                                        <form id="form-custom-link" action="" method="POST" role="form">
                                            <div class="form-group">
                                                ...
                                                <input type="url" class="form-control" id="url"
                                                       placeholder="Input field" value="http://" required="">
                                            </div>
                                            <div class="form-group">
